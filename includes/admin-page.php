    ...
    public static function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <?php if ($active_tab === 'general') : ?>
                <?php
                liteimage_display_general_tab_content();
                liteimage_display_developer_support();
                ?>
            <?php else : ?>
                <?php liteimage_display_usage_tab_content(); ?>
            <?php endif; ?>
        </div>
        <?php
    }
...
function liteimage_display_general_tab_content() {
    ?>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <?php $settings = LiteImage_Settings::get_instance(); ?>
...
function liteimage_display_usage_tab_content() {
    ?>
...
function liteimage_display_developer_support() {
    $settings = LiteImage_Settings::get_instance();
