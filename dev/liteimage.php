    ...
    public static function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <?php if ($active_tab === 'general') : ?>
                ...
                <form method="post" action="options.php">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th scope="row"><?php esc_html_e('Enable Logs', 'liteimage'); ?></th>
                            <td>
                                <input type="checkbox" name="liteimage_settings[enable_logs]" value="1" <?php checked($settings->get('enable_logs'), true); ?>>
                                <label><?php esc_html_e('Enable debug logging', 'liteimage'); ?></label>
                                <p class="description"><?php esc_html_e('Logs plugin operations to liteimage-debug.log in the plugin directory for troubleshooting.', 'liteimage'); ?></p>
                            </td>
                        </tr>
                    </table>
            ...
            <?php else : ?>
                ...
                <p><?php esc_html_e('For <code>liteimage(123)</code>:', 'liteimage'); ?></p>
<pre><code><?php echo esc_attr('<picture role="img">
    <img src="/wp-content/uploads/image.jpg" loading="lazy"
        decoding="async" alt="Image Title" width="1920" height="1080" type="image/jpeg">
</picture>'); ?></code></pre>

                <p><?php esc_html_e('For <code>liteimage(123, ["thumb" => [800, 600], "args" => ["alt" => "Custom Image", "class" => "featured"]])</code>:', 'liteimage'); ?></p>
<pre><code><?php echo esc_attr('<picture role="img">
    <source srcset="/wp-content/uploads/image-800x600.webp" type="image/webp">
    <img src="/wp-content/uploads/image-800x600.jpg" loading="lazy"
        decoding="async" alt="Custom Image" width="800" height="600" type="image/jpeg" class="featured">
</picture>'); ?></code></pre>

                <p><?php esc_html_e('For <code>liteimage(123, ["thumb" => [1280, 720], "min" => ["768" => [1280, 720]], "max" => ["767" => [640, 480]], "args" => ["alt" => "Responsive Image"]], 456)</code>:', 'liteimage'); ?></p>
<pre><code><?php echo esc_attr('<picture role="img">
    <source media="(min-width:768px)" srcset="/wp-content/uploads/image-1280x720.webp" type="image/webp">
    <source media="(max-width:767px)" srcset="/wp-content/uploads/mobile-image-640x480.webp" type="image/webp">
    <img src="/wp-content/uploads/image-1280x720.jpg" loading="lazy"
...
function liteimage($image_id, $data = [], $mobile_image_id = null) {
    ...
    // Ensure thumb_size_name uses the thumb size explicitly
