    ...
    public static function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <?php if ($active_tab === 'general') : ?>
                ...
                <h3><?php _e('Support the Developer', 'liteimage'); ?></h3>
                <p><?php _e('Enjoying LiteImage? Support its development with a Bitcoin (BTC chain) donation!', 'liteimage'); ?></p>
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <a href="bitcoin:1NDUzCkYvKE5qHZnfR9f71NrXL2DJCAVpn?label=LiteImage%20Donation" class="button button-secondary" style="background: #f7931a; border-color: #f7931a; color: #fff; padding: 8px 16px; font-weight: 500; text-decoration: none;" target="_blank">
                            <?php _e('Buy Me a Coffee (BTC)', 'liteimage'); ?>
                        </a>
                        <p style="margin-top: 10px;">
                            ...
                            <span style="color: #28a745; margin-left: 10px; display: none;" id="copy-notice"><?php _e('Copied!', 'liteimage'); ?></span>
                        </p>
                        <p class="description"><?php _e('Send donations to this Bitcoin address (BTC chain): 1NDUzCkYvKE5qHZnfR9f71NrXL2DJCAVpn', 'liteimage'); ?></p>
                    </div>
                </div>
                <script>
            ...
            <?php else : ?>
                ...
                <h3><?php _e('Example Picture Element Outputs', 'liteimage'); ?></h3>
                <p><?php _e('The <code>liteimage</code> function generates a <code>&lt;picture&gt;</code> element with responsive sources. Below are example outputs:', 'liteimage'); ?></p>

                <h4><?php _e('1. Basic Image', 'liteimage'); ?></h4>
                <p><?php _e('For <code>liteimage(123)</code>:', 'liteimage'); ?></p>
                <pre><code><?php echo htmlspecialchars('<picture role="img">
    <img src="http://example.com/wp-content/uploads/image-1920x0.jpg" loading="lazy"
        decoding="async" alt="Image Title" width="1920" height="1080" type="image/jpeg">
</picture>'); ?></code></pre>

                <h4><?php _e('2. Custom Size with WebP', 'liteimage'); ?></h4>
                <p><?php _e('For <code>liteimage(123, ["thumb" => [800, 600], "args" => ["alt" => "Custom Image", "class" => "featured"]])</code>:', 'liteimage'); ?></p>
                <pre><code><?php echo htmlspecialchars('<picture role="img">
    <source srcset="http://example.com/wp-content/uploads/image-800x600.webp" type="image/webp">
    <img src="http://example.com/wp-content/uploads/image-800x600.jpg" loading="lazy"
        decoding="async" alt="Custom Image" width="800" height="600" type="image/jpeg" class="featured">
</picture>'); ?></code></pre>

                <h4><?php _e('3. Responsive with Mobile Image', 'liteimage'); ?></h4>
                <p><?php _e('For <code>liteimage(123, ["thumb" => [1280, 720], "min" => ["768" => [1280, 720]], "max" => ["767" => [640, 480]], "args" => ["alt" => "Responsive Image"]], 456)</code>:', 'liteimage'); ?></p>
                <pre><code><?php echo htmlspecialchars('<picture role="img">
    <source media="(min-width:768px)" srcset="http://example.com/wp-content/uploads/image-1280x720.webp" type="image/webp">
    <source media="(max-width:767px)" srcset="http://example.com/wp-content/uploads/mobile-image-640x480.webp" type="image/webp">
    <img src="http://example.com/wp-content/uploads/image-1280x720.jpg" loading="lazy"
        decoding="async" alt="Responsive Image" width="1280" height="720" type="image/jpeg">
</picture>'); ?></code></pre>
